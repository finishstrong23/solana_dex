...
export default function Dashboard() {
  ...
  const recentTrades = [
    { from: "SOL", to: "USDC", amount: "12.5", value: "$2,230.25", time: "2m ago", type: "sell" as const },
    { from: "USDC", to: "JUP", amount: "500", value: "$500.00", time: "5m ago", type: "buy" as const },
    { from: "SOL", to: "BONK", amount: "3.2", value: "$570.94", time: "8m ago", type: "buy" as const },
    { from: "RAY", to: "USDC", amount: "200", value: "$574.00", time: "12m ago", type: "sell" as const },
    { from: "WIF", to: "SOL", amount: "1,500", value: "$2,880.00", time: "15m ago", type: "buy" as const },
    { from: "JTO", to: "USDC", amount: "300", value: "$1,068.00", time: "22m ago", type: "sell" as const },
  ];
                    ...
                    <td className="px-4 py-3 text-right">
                      <span
                        className={`inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full ${
                          token.change24h >= 0 ? "bg-green/10 text-green" : "bg-red/10 text-red"
                        }`}
                      >
                        {token.change24h >= 0 ? (
